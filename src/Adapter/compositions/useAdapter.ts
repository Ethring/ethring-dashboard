...
interface WalletInfo {
    id: string;
    account: any; // тип аккаунта определите сами
    address: string | null;
    addresses: Record<string, string>; // тип адресов определите сами
...
function useAdapter() {
    ...
    const getChainByChainId = (ecosystem = null, chainId: string | number): ChainConfig => {
