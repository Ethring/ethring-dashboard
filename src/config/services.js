...
const ALL_SERVICES = [
    {
        ...
        url: import.meta.env.VITE_DEBRIDGE_API,
    ...
    },
    {
        ...
        url: import.meta.env.VITE_SQUID_ROUTER_API,
        tokensByChain: true,
        namespace: ECOSYSTEMS.EVM,
        estimatedTime: {
            1: 60,
    ...
    },
    {
        ...
        url: import.meta.env.VITE_SKIP_API,
        tokensByChain: true,
    ...
    },
    {
        ...
        url: import.meta.env.VITE_PARASWAP_API,
        tokensByChain: false,
        namespace: ECOSYSTEMS.EVM,
        estimatedTime: {
            1: 60,
    ...
    },
    {
        ...
        url: import.meta.env.VITE_SYNAPSE_SWAP_API,
        tokensByChain: true,
        isStableSwap: true,
        namespace: ECOSYSTEMS.EVM,
        estimatedTime: {
