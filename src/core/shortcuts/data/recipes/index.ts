...
const RECIPES: Record<string, IRecipesWithOperations> = {
    ...
    [AvailableShortcuts.PendleBeefy]: {
        ...
        operations: [
            {
                id: 'swap-exact-tokens-for-ezETH',
                name: 'Swap your tokens to ezETH (Pendle)',
                type: ShortcutType.operation,
                ...
                includeChains: ['arbitrum'],
                includeTokens: {
                    arbitrum: ['arbitrum:tokens__native:ETH', 'arbitrum:tokens__0x2416092f143378750bb29b79ed961ab195cceea5:EZETH'],
                },
                ecosystems: ['EVM'],
                operationParams: {
                    net: 'arbitrum',
            ...
            {
                id: 'give-approval-for-ezETH',
                name: 'Give approval for ezETH to LP ezETH',
                type: ShortcutType.operation,
                make: TRANSACTION_TYPES.APPROVE,
                moduleType: ModuleType.pendleBeefy,
                operationType: TRANSACTION_TYPES.CALL_CONTRACT_METHOD,
                ...
                dependencies: {
                    operationId: 'swap-exact-tokens-for-ezETH',
                    operationParams: [
                        {
                            dependencyParamKey: 'amount',
                            paramKey: 'amount',
            ...
            } as IShortcutOp,
            {
                ...
                name: 'Give approval for LP ezETH to ezETH - Beefy',
                type: ShortcutType.operation,
                make: TRANSACTION_TYPES.APPROVE,
                moduleType: ModuleType.pendleBeefy,
                operationType: TRANSACTION_TYPES.CALL_CONTRACT_METHOD,
