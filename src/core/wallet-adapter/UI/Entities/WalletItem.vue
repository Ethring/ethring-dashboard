<template>
    ...
    >
        ...
        <div v-if="isCosmosConnected" class="check-icon">
            <CheckIcon />
        </div>
    </div>
</template>
...
export default {
    ...
    setup() {
        ...
        if (connectedWallets.value) isCosmosConnected.value = connectedWallets.value.find((wallet) => wallet.walletName === 'Keplr');
