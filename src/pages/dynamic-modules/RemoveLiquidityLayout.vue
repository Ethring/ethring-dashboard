...
export default {
    ...
    setup() {
        ...
        const onSelectToken = () => handleOnSelectToken({ direction: DIRECTIONS.SOURCE, type: TOKEN_SELECT_TYPES.TO });
        const onSelectNetwork = () => handleOnSelectNetwork({ direction: DIRECTIONS.SOURCE, type: TOKEN_SELECT_TYPES.FROM });
        const onSelectPool = () => handleOnSelectPool({ direction: DIRECTIONS.SOURCE, type: TOKEN_SELECT_TYPES.FROM });
