...
test.describe('SuperSwap e2e tests', () => {
    ...
    test('Case#2: SuperSwap tx from ETH to BSС wEth to USDC', async ({ browser, context, page: Page, superSwapPage }) => {
        await superSwapPage.setDataAndClickSwap('Binance Smart Chain', '0.05');
    ...
    test('Case#3: Verifying data reset when navigating to swap page', async ({ page: Page, superSwapPage }) => {
