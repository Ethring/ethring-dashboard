...
import { EVM_NETWORKS, errorEstimateSwap, mockBalanceDataBySwapTest } from '../data/mockHelper';
import mockTokensList, { INCORRECT_IMAGE_URL } from '../data/mockTokensList';
import { TEST_CONST, getTestVar } from '../envHelper';
import { MetaMaskNotifyPage } from '../model/MetaMask/MetaMask.pages';
import { getNotifyMmPage } from '../model/MetaMask/MetaMask.pages';
